...
% TASLAK — [SONUC:...] alanlari Gorev A/B ciktilariyla doldurulacak.
...
Best GLA: LR $3\mathrm{e}{-4}$, val loss [SONUC: ort $\pm$ std], PPL [SONUC]
(seed-0: 5.458, PPL $\approx$ 234). HFP-best (\code{cubic+additive+dpfp},
PPL 183.6) [SONUC: leads by X PPL / criterion verdict].
...
Result: [SONUC: tablo + hukum]. The official recipe is therefore
[SONUC: recete].
