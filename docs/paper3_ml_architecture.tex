...
(3 seeds). HFP-best (\code{cubic+additive+dpfp}, val loss $5.2127 \pm 0.0035$,
PPL 183.6) leads by 43.1 PPL --- a val-loss margin of $0.2111$ at combined
SE $0.0307$ ($\approx 6.9$~SE). The pre-registered family-standard criterion
(HFP within $-2$~SE of the GLA mean or better) is passed decisively: at equal
parameters HFP beats, not merely matches, the family representative. GLA's
seed variance is $\sim$15$\times$ HFP's (0.053 vs.\ 0.0035).
...
per-head alpha-gate. A scaling-relevant observation: HFP degrades with
evaluation length (PPL 189 $\to$ 213 at $8\times$ train length) while GLA is
flat ($\sim$225--231); HFP still leads at 2048 (213 vs.\ 226) but the margin
narrows from 42 to 13 PPL.
